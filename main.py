...
class Main(QMainWindow):
    ...
    def toolBar(self):
        ...
        self.tb.addSeparator()
        #####################   Retrive Image           #######################
        self.retriveBtn = QAction(QIcon('icons/users.png'), "Retrive", self)
        self.tb.addAction(self.retriveBtn)
        self.retriveBtn.triggered.connect(self.retriveImage)
    ...
    ######################   Main left layout widget ###############
        ...
        self.vstWallTable.horizontalHeader().setSectionResizeMode(1, QHeaderView.Stretch) #Streching to the header of Product Name
        self.vstWallTable.horizontalHeader().setSectionResizeMode(2, QHeaderView.Stretch) #Streching to the head of Manufacturer
    ...
    def searchMembers(self):
        ...
        if value == "":
            ...
            self.searchEntry.setText("")
            query = ("SELECT * FROM members WHERE member_name LIKE ? or member_surname LIKE ? or member_phone LIKE ?") # przy produktach nie dawalismy * bo nie chcielismy obrazka
...
class DisplayProduct(QWidget):
    ...
    def updateProduct(self):
        ...
        if (name and manufacturer and price and qouta !=""):
            try:
                ...
                con.commit()
                QMessageBox.information(self, "Info", "Product has been updated successfully! Please make the rest of wished updates or close the 'Display Product' window to see the overview")
            except:
    ...
    def deleteProduct(self):
        ...
        mbox=QMessageBox.question(self, "You are deleting assortment!", "Are you sure to delete this product", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
